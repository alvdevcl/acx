...
variable "secman_name" {
  type        = string
  description = "Secret Manager name storing spreadsheet-processing-service specific secrets"
}
...
variable "postgres_database" {
  type        = string
  description = "Spreadsheets service postgres database name"
}
...
variable "k8s_replica_count" {
  type = string
  description = "Spreadsheet Processing Service Service pod count"
}
